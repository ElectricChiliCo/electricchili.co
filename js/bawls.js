...
function init () {
  ...
  var bawlSizes = [bSize, bSize*5.5, bSize*2, bSize*3.8, bSize*1.7, bSize*2.5, bSize/1.5, bSize*12, bSize/1.1, bSize*1.5, bSize*1.8, bSize*3, bSize*4.4, bSize*2, bSize/2, bSize*4, bSize, bSize, bSize*1.2, bSize*6.3];//[11, 13, 15, 17, 19];
  ...
  // set starting places
  var bawlPlace = {'x' : [wCenter.x + wWidth/20, wCenter.x + wWidth/8, wCenter.x + wWidth/5, wCenter.x - wWidth/3.2, wCenter.x - wWidth/15, wCenter.x - wWidth/4, wCenter.x - wWidth/10, wCenter.x - wWidth/12, wCenter.x + wWidth/2.5, wCenter.x + wWidth/4.8, wCenter.x, wCenter.x, wCenter.x + wWidth/9, wCenter.x + wWidth/7, wCenter.x + wWidth/16, wCenter.x - wWidth/8, wCenter.x + wWidth/6, wCenter.x - wWidth/4.4, wCenter.x - wWidth/7, wCenter.x + wWidth/3.5], 'y' : [wCenter.y + wHeight/20, wCenter.y - wHeight/4.5, wCenter.y + wHeight/8, wCenter.y + wHeight/3.5, wCenter.y, wCenter.y - wHeight/4.5, wCenter.y - wHeight/2.5, wCenter.y + wHeight/12, wCenter.y - wHeight/3, wCenter.y - wHeight/8, wCenter.y + wHeight/2.5, wCenter.y - wHeight/6, wCenter.y + wHeight/8, wCenter.y + wHeight/5.2, wCenter.y - wHeight/3, wCenter.y - wHeight/14, wCenter.y + wHeight/20, wCenter.y + wHeight/12, wCenter.y - wHeight/4, wCenter.y + wHeight/20]};
  ...
  for (i = 0, len = bawls.length; i < len; i++) {
    bawls[i] = {
      ...
      bawls[i].vx = Math.random()/(14)*posNeg[Math.floor(Math.random()*posNeg.length)],
      bawls[i].vy = Math.random()/(16)*posNeg[Math.floor(Math.random()*posNeg.length)],
